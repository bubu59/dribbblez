...
import RelatedProjects from "@/components/card/RelatedProjects"
import ProjectActions from "@/components/card/ProjectActions"
// import ProjectActions from "@/components/ProjectActions"
...
const Project = async ({ params: { id } }: { params: { id: string } }) => {
    ...
    console.log('prjoectDetails', projectDetails)
